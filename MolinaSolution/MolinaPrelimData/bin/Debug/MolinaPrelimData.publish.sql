/*
Deployment script for MolinaPreLim
...
GO
:setvar DatabaseName "MolinaPreLim"
:setvar DefaultFilePrefix "MolinaPreLim"
...
CREATE TABLE [dbo].[Students] (
    ...
    [Year]  INT           NOT NULL,
    CONSTRAINT [PK_STUDENT_NAME] PRIMARY KEY CLUSTERED ([Name] ASC)
);


GO
PRINT N'Creating Index [dbo].[Students].[IX_STUDENT_NAME]...';


GO
CREATE NONCLUSTERED INDEX [IX_STUDENT_NAME]
    ON [dbo].[Students]([Name] ASC);
